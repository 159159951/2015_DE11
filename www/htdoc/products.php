		...
		<div id="homepage">
			<div class="page">
				...
				<header class="fshop-header">
					...
					<div class="fshop-store"><a target="_blank" href="" tppabs="" title="Cửa hàng FPTShop">Danh Sách Cửa hàng</a></div>
								...
								<?php
									//Select tat ca danh muc cha
															...
															while ($row = mysql_fetch_array($sql))
															{
																?>
								<li>
									<a href="<?php echo "products.php?type=". $row["table_data"] ?>" class="">
			...
			<div class="top-slider">
				<div class="home-slider">
					...
					<div style="float:left;padding-left:10px;width:25%;height:300px;">
						<div class="pgwSlider narrow">
							<div class="ps-current" style="width: 100%; height: 284px;">
								<ul>
									<li class="elt_1" style="opacity: 1; z-index: 2; display: list-item;"><a href="" target="_blank"><img src="../images/slide/hr1.jpg" alt=""></a></li>
									<li class="elt_2" style="z-index: 1; display: none; opacity: 0;"><a href="" target="_blank"><img src="../images/slide/hr2.jpg" alt=""></a></li>
								</ul>
								<span class="ps-caption" style="display: none;"></span>
							</div>
							<ul class="top-right-ads ps-list" style="display: none;">
					...
					<div class="main">
								...
								<?php
									...
									if(isset($_GET["tukhoa"]))
									{
										...
										$result= mysql_query("SELECT COUNT(*) FROM ".
											"(SELECT * FROM `".$table_name."` WHERE Name like \"%{$_GET["tukhoa"]}%\" ". 
												" UNION ".
												" SELECT * FROM `".$table_name."` WHERE Feature like \"%{$_GET["tukhoa"]}%\" ". 
												" UNION ".
												" SELECT * FROM `".$table_name."` WHERE Warrantee like \"%{$_GET["tukhoa"]}%\") ".
										"AS A",$connect);
									}
									elseif (isset($_GET["Brand"]))
															//Kiem xem co tat ca bao nhieu san pham
										$result= mysql_query("select count(*) from ".$table_name." where Brand=\"".$_GET["Brand"]."\"",$connect);
									else
															//Kiem xem co tat ca bao nhieu san pham
										$result= mysql_query("select count(*) from ".$table_name."",$connect);
						...
						<div>
							<?php						
								...
								{ 
								?>
							<a type="button" class="btn btn-warning" <?php if(!isset($_GET["type"])) echo "href=\"?trang=$i\""; else echo "href=\"?type=".$_GET["type"]."&trang=$i\""; ?>>
							Trang <?php echo $i; ?>
							</a>
							<?php
								}
